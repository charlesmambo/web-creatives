        ...
        <div className="vm-wrapper">
            <div className="vm-content">
                <div className="vm-card">
                    <h3>Vision</h3>
                    <p>Our vision is to be a leading creative partner recognized for excellence and innovation, empowering businesses to thrive in a digital-first world.</p>
                </div>
                <div className="vm-card">
                    <h3>Mission</h3>
                    <p>At Webb Creatives, our mission is to bridge the gap between creativity and technology, delivering innovative solutions that drive growth and success through collaboration.</p>
                </div>
            </div>
